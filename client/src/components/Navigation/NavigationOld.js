                ...
                <ul className="menu">
                    {isAuthenticated ?
                        <>
                            ...
                            <li><NavLink style={({ isActive }) => ({ color: isActive ? 'brown' : 'black' })} to="/catalog">Catalog</NavLink></li>
                        ...
                        :
                        <>
                            <li><NavLink style={({ isActive }) => ({ color: isActive ? 'brown' : 'black' })} to="ccccccccccccccccccccc">Gallery</NavLink></li>
